	...
	public boolean modifyProjectDetails(Project project) {
		...
		try(Connection connection= DbConnection.getConnection()){
			...
			try(PreparedStatement preparedStatement=connection.prepareStatement(sql)){
				setParameter(preparedStatement, 1, project.getProjectName(), String.class);
				setParameter(preparedStatement, 2, project.getEstimatedHours(), BigDecimal.class);
				setParameter(preparedStatement, 3, project.getActualHours(), BigDecimal.class);
				setParameter(preparedStatement, 4, project.getDifficulty(), Integer.class);
				setParameter(preparedStatement, 5,project.getNotes(),String.class);
				setParameter(preparedStatement, 6, project.getProjectId(), Integer.class);
				 boolean modified= preparedStatement.executeUpdate() == 1;
